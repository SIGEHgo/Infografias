...
prueba = prueba |> 
  dplyr::mutate(
    `Zona Metropolitana` = dplyr::if_else(condition = is.na(`Zona Metropolitana`), true = "Otros", false = `Zona Metropolitana`)
  )

prueba |>  openxlsx::write.xlsx("Output/Infografia_Base_Zona_Metropolitana_Sin_Operaciones_2026_Enero.xlsx")
