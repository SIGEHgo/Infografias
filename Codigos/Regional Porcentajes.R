datos = "Output/Infografia_Base_Regional_Sin_Operaciones_2026_Enero.xlsx" |>  readxl::read_excel()
...
datos |>  openxlsx::write.xlsx("Output/Infografia_Base_Regional_2026_Enero.xlsx")
