datos = "Output/Infografia_Base_Estatal_Sin_Operaciones_2026_Enero.xlsx" |>  readxl::read_excel()
...
datos |>  openxlsx::write.xlsx("Output/Infografia_Base_Estatal_2026_Enero.xlsx")
